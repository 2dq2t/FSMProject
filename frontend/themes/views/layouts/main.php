            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul class="right">
                    ...
                    if(!Yii::$app->user->isGuest) {
                       echo "<li>";
                       echo "<a href='#'><i class='fa fa-exchange'></i> compare <span class='value'>(2)</span> </a>";
                       echo "</li>";
                    }
                    ?>
                    <?php
                    if(Yii::$app->user->isGuest) {
                        ...
                        echo "<li role='presentation'><a role='menuitem' tabindex='-1' href='".$baseUrl."/index.php?r=site/logout' data-method='post'>[ Thoát ]</a></li>";
                        echo "</ul>";
                        echo "</li>";
                    }
                    ?>
                ...
                <div class="col-xs-12 col-md-6 no-margin">
                    ...
                    <div class="link-widget">
                        <div class="widget">
                            <h3>Thông tin về</h3>
                            <ul>
                                <li><a href="category-grid.html">Cam kết chất lượng</a></li>
                                <li><a href="category-grid.html">Tuyển dụng</a></li>
                                <li><a href="category-grid.html">Phản hồi khách hàng</a></li>
                    ...
                    <div class="link-widget">
                        <div class="widget">
                            ...
                            <ul>
                                <li><a href="category-grid.html">Điều khoản sử dụng</a></li>
                                <li><a href="category-grid.html">Chính sách bảo mật</a></li>
                                <li><a href="category-grid.html">Cách thức thanh toán</a></li>
                                <li><a href="category-grid.html">Hướng dẫn đặt hàng</a></li>
                                <li><a href="category-grid.html">Chính sách đổi trả hàng</a></li>
                                <li><a href="category-grid.html">Sử dụng và bảo quản rau sạch</a></li>
                                <li><a href="category-grid.html">Cẩm nang gia đình</a></li>
                                <li><a href="category-grid.html">Hỏi đáp</a></li>
