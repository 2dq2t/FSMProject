...
<?= Html::a('<i class="fa fa-angle-left"></i> ' . Yii::t('app', 'Back'), ['permission/index'], ['class' => 'btn btn-default btn-circle']) ?>
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    <div class="form-group">
                        <?= $form->field($model, 'name')->textInput(['maxlength' => 64, 'placeholder' => Yii::t('app', 'Enter permission name')]) ?>
                        <?= $form->field($model, 'oldName', ['template' => '{input}'])->input('hidden'); ?>
                    </div>
                    <div class="form-group">
                        <?= $form->field($model, 'description')->textarea(['rows' => 3, 'placeholder' => Yii::t('app', 'Enter permission description')]) ?>
                    </div>
                    ...
                    <div class="form-group">
                        <?= $form->field($model, 'data')->textarea(['rows' => 6, 'placeholder' => Yii::t('app', 'Enter permission data')])?>
                    </div>
                </div>
