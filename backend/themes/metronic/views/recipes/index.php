...
<div class="recipes-index">
    ...
    $gridColumns = [
        ...
        [
            ...
            'format' => 'raw',
            'value' => function (\common\models\Recipes $model) {
    ...
    <?= GridView::widget([
        ...
        'toolbar' =>  [
            ['content'=>
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['recipes/index'], ['data-pjax'=>0, 'class' => 'btn btn-default', 'title'=>'Reset Grid'])
            ],
            '{toggleData}',
            '{export}',
        ],
...
//            'neverTimeout'=>true,
        ...
        'panel' => [
            ...
            'heading' => $this->title,
            'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'Create Recipes'), ['create'], ['class' => 'btn btn-success']),
        ],
    ]); ?>
