            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <?= $form->field($model, 'name')->textInput(['maxlength' => 64, 'placeholder' => $model->type == \yii\rbac\Item::TYPE_PERMISSION ? Yii::t('app', 'Enter permission name') : Yii::t('app', 'Enter role name')]) ?>
                    </div>
                    <div class="form-group">
                        <?= $form->field($model, 'description')->textarea(['rows' => 3, 'placeholder' => $model->type == \yii\rbac\Item::TYPE_PERMISSION ? Yii::t('app', 'Enter permission description') : Yii::t('app', 'Enter role description')]) ?>
                    </div>

                    <div class="form-group">
                        <?= (!empty($rules)) ? $form->field($model, 'rule_name')->dropDownList($rules, ['prompt' => 'Choose rule']) : '' ?>

                        <?= $form->field($model, 'children')->multiselect($items, [
                            'height' => '100%',
