...
<header>
    <div class="container no-padding">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 top-search-holder no-margin">
            <div class="contact-row">
                <div class="phone inline">
                    <i class="fa fa-phone"></i> (+84) 0123.549.7019
                </div>
                <div class="contact inline">
                    <i class="fa fa-envelope"></i> freshgarden@<span class="le-color">gmail.com</span>
                </div>
            </div>
            <!-- /.contact-row -->
            <!-- ============================================================= SEARCH AREA ============================================================= -->
                        ...
                        <ul class="categories-filter animate-dropdown">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">laptops</a>
                                    </li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">tv
                                            & audio</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">gadgets</a>
                                    </li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">cameras</a>
                                    </li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-2 top-cart-row pull-right">
                                ...
                                <div class="basket-item">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-5 no-margin">
                                            <a href="cart.html" class="le-button inverse">Giỏ hàng</a>
                                        </div>
                                        <div class="col-xs-12 col-sm-7">
                                            <a href="checkout.html" class="le-button">Thanh toán</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
