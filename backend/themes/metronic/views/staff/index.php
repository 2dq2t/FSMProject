...
<div class="staff-index">
    ...
    $gridColumns = [
        ...
        [
            ...
            'filter'=>\yii\helpers\ArrayHelper::map(\backend\models\Staff::find()->orderBy('full_name')->asArray()->all(), 'full_name', 'full_name'),
            'filterWidgetOptions'=>[
                'pluginOptions'=>['allowClear'=>true],
            ],
            'filterInputOptions'=>['placeholder'=>'staff full name'],
            'format'=>'raw'
        ],
        [
            'attribute' => 'gender',
            ...
            'format' => 'raw',
            'value' => function (\backend\models\Staff $model) {
    ...
    <?= GridView::widget([
        ...
        'toolbar' =>  [
            ['content'=>
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['staff/index'], ['data-pjax'=>0, 'class' => 'btn btn-default', 'title'=>'Reset Grid'])
            ],
            '{toggleData}',
            '{export}',
        ],
