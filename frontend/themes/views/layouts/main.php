...
<div class="logo">
	<a href="index.html">
		<!--<img alt="logo" src="mediacenter/assets/images/logo.svg" width="233" height="54"/>-->
		<!--<object id="sp" type="image/svg+xml" data="mediacenter/assets/images/logo.svg" width="233" height="54"></object>-->
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <div class="basket-item-count">
                    ...
                    <img src="mediacenter/assets/images/icon-cart.png" alt="" />
                </div>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                    <img alt="" src="mediacenter/assets/images/products/product-small-01.jpg" />
                                </div>
                            </div>
        ...
        <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-01.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-02.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">                        
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-03.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-04.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-05.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-06.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-07.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-08.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="mediacenter/assets/images/blank.gif" data-echo="mediacenter/assets/images/products/product-small-09.jpg" />
                        </a>
                    </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="mediacenter/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="mediacenter/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="mediacenter/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="mediacenter/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
