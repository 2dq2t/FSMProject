                    ...
                    <ul class="right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" >
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Tiếng Anh</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Tiếng Pháp</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Tiếng Trung</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Tiếng Nga</a></li>
                            </ul>
                        </li>
                        <?php
                            if(Yii::$app->user->isGuest) {
                                echo "<li><a href='index.php?r=site/register'>Đăng ký</a></li>";
                                echo "<li><a href='index.php?r=site/login'>Đăng nhập</a></li>";
                            }else{
                                echo "<li class='dropdown'>";
                                echo "<a class='dropdown-toggle'  data-toggle='dropdown' href='#'>".Yii::$app->user->identity->username."</a>";
                                echo "<ul class='dropdown-menu' role='menu'>";
                                echo "<li role='presentation'><a role='menuitem' tabindex='-1' href='#'>Quản lý tài khoản</a></li>";
                                echo "<li role='presentation'><a role='menuitem' tabindex='-1' href='index.php?r=customer/update&id=".Yii::$app->user->identity->id."'>Thông tin tài khoản</a></li>";
                                echo "<li role='presentation'><a role='menuitem' tabindex='-1' href='#'>Đơn hàng của tôi</a></li>";
                                echo "<li role='presentation'><a role='menuitem' tabindex='-1' href='#'>Đơn hàng yêu thích</a></li>";
                                echo "<li role='presentation'><a role='menuitem' tabindex='-1' href='#'>Mã khách hàng của tôi</a></li>";
                                echo "<li role='presentation'><a role='menuitem' tabindex='-1' href='/FSMProject/frontend/web/index.php?r=site/logout' data-method='post'>[ Thoát ]</a></li>";
                                echo "</ul>";
                                echo "</li>";
                           }
                        ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
                    <div class="contact-row">
                        ...
                        <div class="contact inline">
                            <i class="fa fa-envelope"></i> lienhe@<span class="le-color">pdms.com</span>
                        </div>
                    </div><!-- /.contact-row -->
                    <!-- ============================================================= SEARCH AREA ============================================================= -->
                    <div class="search-area">
                        <form>
                            <div class="control-group">
                                <input class="search-field" placeholder="Nhập từ khóa cần tìm kiếm ... " />

                                <ul class="categories-filter animate-dropdown">
                                    <li class="dropdown">

                                        <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.html">Tất cả</a>

                                        <ul class="dropdown-menu" role="menu" >
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">Rau sạch</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.html">Hoa quả sạch</a></li>
