    ...
    <div class="container">
        ...
        <div class="no-margin col-xs-12 col-sm-7 body-holder">
            <div class="body">
                ...
                <div class="availability"><label>Availability:</label><span class="available"><?php if($productDetail[0]['quantity']-$productDetail[0]['sold']>0) echo  $productDetail[0]['quantity']-$productDetail[0]['sold']; else echo "Trong kho";?></span></div>
                ...
                <div class="text"><p><strong class="inline">Tiêu chuẩn:</strong><span class="inline" style="margin-left: 3px"><a href="http://vietgap.gov.vn/Content.aspx?mode=uc&page=About&Option=7" target="_blank" rel="nofollow">Chứng nhận rau an toàn VIETGAP</a></span> </p></div>
                ...
                <div class="buttons-holder">
                    <a class="btn-add-to-wishlist" href="#">Thêm vào danh mục yêu thích</a>
                </div>
                        ...
                        <div class="comment-item">
                            <div class="row no-margin">
                                <div class="col-lg-1 col-xs-12 col-sm-2 no-margin">
                                    <div class="avatar">
                                        <img alt="avatar" src="mediacenter/assets/images/default-avatar.jpg">
                                    </div>
                                    <!-- /.avatar -->
                                </div>
                                <!-- /.col -->
