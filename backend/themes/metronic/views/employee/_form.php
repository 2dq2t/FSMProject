...
<div class="form-group no-margin">
    <?= Html::a(Yii::t('app', 'Back'), ['employee/index'], ['class' => 'btn default']) ?>
                        ...
                        if ($city->id) {
                            echo $form->field($district, 'id')->dropDownList(
                                ...
                                [
                                    ...
                                    'onchange'=>'
                                            $.post( "index.php?r=employee/getward&id="+$(this).val(), function( file ) {
                        ...
                        if ($district->id) {
                            ...
                            echo $form->field($address, 'ward_id')->widget(\kartik\widgets\DepDrop::classname(), [
                                ...
                                'pluginOptions'=>[
                                    ...
                                    'url'=>\yii\helpers\Url::to(['/employee/getward'])
                                ]
                            ]);
                        }
