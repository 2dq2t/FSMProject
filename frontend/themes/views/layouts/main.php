...
<!--                        <li><a href="authentication.html">Login</a></li>-->
                        <?php
                            if(Yii::$app->user->isGuest) {
                                echo "<li><a href='index.php?r=site/register'>Register</a></li>";
                                echo "<li><a href='index.php?r=site/login'>Login</a></li>";
                            }else{
                                echo "<li><a href='/FSMProject/frontend/web/index.php?r=site/logout' data-method='post'>".Yii::$app->user->identity->username."</a></li>";
                            }
                        ?>
                    </ul>
                </div><!-- /.col -->
