...
if($model->image) {
    if(file_exists('../../frontend/web/uploads/regulationpolicy/'. $model->id . '/' . $model->image)) {
        $path = Html::img('../../frontend/web/uploads/regulationpolicy/' . $model->id . '/' . $model->image, ['class' => 'file-preview-image']);
    }
}
?>
...
<div class="form-group no-margin">
    ...
    <?= Html::a('<i class="fa fa-angle-left"></i> '. Yii::t('app', 'Back'), ['regulationpolicy/index'], ['class' => 'btn btn-default btn-circle']) ?>
