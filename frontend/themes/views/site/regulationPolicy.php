    ...
    <div class="row content-subinner">
        ...
        <div id="content" class="col-sm-9 information-information">
            ...
            <div class="aboutus"><h1><a
                        href="<?= "index.php?r=site/regulation-policy&rp=" . $item['alias'] ?>"></a><?= $item['title'] ?>
                </h1>

                <div class="image1"><img src="<?= "uploads/regulationpolicy/" . $item['id'] . "/" . $item['image'] ?>"
                                         width="60" height="60">&nbsp;</div>
                <div class="content"><?php $item['post_info'] ?></div>
                <?php endforeach ?>
