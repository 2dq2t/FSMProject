...
class Staff extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
//            [['full_name', 'password', 'dob', 'gender', 'phone_number', 'email', 'image', 'start_date', 'address_id', 'status'], 'required'],
            ...
            [['full_name', 'password', 'email', 'image'], 'string', 'max' => 255],
            [['email'], 'unique'],
            [['email'], 'email'],
...
//            'password_reset_token' => Yii::t('app', 'Password Reset Token'),
    ...
    {
        return $this->hasMany(DataExport::className(), ['staff_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Object::className(), ['id' => 'object_id'])->viaTable('data_import', ['staff_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(DataImport::className(), ['staff_id' => 'id']);
    }
